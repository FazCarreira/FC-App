...
const CadastrosFacilitador = () => {
    ...
    const facilitadoresArr = useMemo(_ => parceiros?.filter(p => p?.profile?.tipo === 'facilitador').map(facilitador => createTableData(
        facilitador.avatar,
            ...
            <Paper>
                <List>
                    <ListItem button onClick={handleNew(CadastroForm)}>
                        ...
                        <ListItemText primary="ADICIONE UM FACILITADOR" />
                    </ListItem>
